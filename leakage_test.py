# This is the code that will be sent to run on Quantinuum's device to test leakage detection
# Plan is to run 12 qubits at depth 84 for 1000 trials each with and without leakage
# May also experiment with using more than 1 qubit for leakage detection
