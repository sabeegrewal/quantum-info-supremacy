...
# 0.426762529
plt.hlines(mu, 0, 250, colors='#8064A2', linestyles='dotted', linewidth=1.5, label=r"Observed $\mu$")
# 0.361467885
plt.hlines(mu - 5 * sigma, 0, 250, colors='#E75D72', linestyles='dotted', linewidth=1.5, label=r"Observed $\mu - 5\sigma$")
